...
export const pentiAkhar: PentiAkharCell[] = [
  ...
  { id: 19, letter: "ਢ",  name: "ਢੱਡਾ",  transliteration: "Dhadda",   audioSlug: "ਢ", playbackSeconds: 1.15 },
  { id: 20, letter: "ਣ",  name: "ਣਾਣਾ",  transliteration: "Nanna",    audioSlug: "ਣ" },
  { id: 21, letter: "ਤ",  name: "ਤੱਤਾ",  transliteration: "Tatta",    audioSlug: "ਤ", playbackSeconds: 1.2 },
  { id: 22, letter: "ਥ",  name: "ਥੱਥਾ",  transliteration: "Thatha",   audioSlug: "ਥ" },
  { id: 23, letter: "ਦ",  name: "ਦੱਦਾ",  transliteration: "Dada",     audioSlug: "ਦ" },
  { id: 24, letter: "ਧ",  name: "ਧੱਦਾ",  transliteration: "Dhada",    audioSlug: "ਧ", playbackSeconds: 1.0 },
  { id: 25, letter: "ਨ",  name: "ਨੱਨਾ",  transliteration: "Nana",     audioSlug: "ਨ", playbackSeconds: 1.15 },
  { id: 26, letter: "ਪ",  name: "ਪੱਪਾ",  transliteration: "Pappa",    audioSlug: "ਪ", playbackSeconds: 1.25 },
  { id: 27, letter: "ਫ",  name: "ਫੱਫਾ",  transliteration: "Phappha",  audioSlug: "ਫ", playbackSeconds: 1.1 },
  { id: 28, letter: "ਬ",  name: "ਬੱਬਾ",  transliteration: "Babba",    audioSlug: "ਬ" },
  { id: 29, letter: "ਭ",  name: "ਭੱਬਾ",  transliteration: "Bhabba",   audioSlug: "ਭ", playbackSeconds: 1.3 },
